...
class light_RT {
    ...
    public:
        ...
        // operations: move for the camera to start ...
        void move_by(ray_RT::value_type mx, ray_RT::value_type my, ray_RT::value_type mz) {
            _position = _position + ray_RT{mx, my, mz} ;
        }
        void set_albedo(const mAlbedo& la) { _color = la ; }
...
class cl_seqLightsRT {
    ...
    public:
        ...
        // access
        std::vector <light_RT>& data() { return _base ; }
